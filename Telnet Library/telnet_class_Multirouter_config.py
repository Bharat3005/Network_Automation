...
r1_dict = {'host': '192.168.122.101', 'username': 'Bharat', 'password': 'Nyk@@123#', 'enable_password': 'Nyk@@123#', 'loopback_ip': '1.1.1.1'}
r2_dict = {'host': '192.168.122.102', 'username': 'Bharat', 'password': 'Nyk@@123#', 'enable_password': 'Nyk@@123#', 'loopback_ip': '2.2.2.2'}
r3_dict = {'host': '192.168.122.103', 'username': 'Bharat', 'password': 'Nyk@@123#', 'enable_password': 'Nyk@@123#', 'loopback_ip': '3.3.3.3'}
